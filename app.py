...
# ---- Tableau des ventes enregistrées ----
st.header("📄 Ventes enregistrées")
st.dataframe(st.session_state.data, use_container_width=True)

# ---- Résumé croisé par employé et assurance ----
st.header("📊 Résumé mensuel (tableau croisé)")
...
with st.expander("🔐 Paramètres API Google Drive (renseigner ces valeurs pour activer l’upload)"):
